...
| `skill-duplicate-tool-refs/` | Synthetic Claude Code Agent Skill (`dup-skill`) with a duplicated `allowed-tools` entry (`Read`/`read`), exercising CSKILL-061 end-to-end |
